...
if ($waktu > 03.00 && $waktu < 10.00) {
    $salam = "Selamat Pagi, ";
} else if ($waktu > 10.00 && $waktu < 16.00) {
    $salam = "Selamat Siang, ";
} else if ($waktu > 16.00 && $waktu < 19.00) {
    $salam = "Selamat Sore, ";
} else {
    $salam = "Selamat Malam, ";
}
    ...
    <div class="badan">
        ...
        <nav class="navigation">
            ...
            <div class="container">
                ...
                <h2 align="center" class="content">Welcome!, <?= $_POST["nama"] ?> </h2>
                ...
                <div class="welcome">
                    <a href="index.html">&#10006;</a>
                    <h2>Sekarang adalah pukul <?= $waktu ?></h2>
                    <h2><?= $salam ?> <?= $_POST["nama"] ?></h2>
                </div>
            </div>
        </nav>
